 ...
 */
public class Units implements Comparable<Units>, Cloneable {
    ...
    public Units(float value) {
        this.value = value;
    }

    public Units(float value, String extX) {
        this.value = value;
        this.extX = extX;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof Units)) return false;
    ...
    @Override
    protected Units clone() {// 转化为深度拷贝，防止在集合中排序时的引用问题
        try {
